...
import icon from '../../../assets/images/cheese-2.jpg';
                    ...
                    <View style={styles.productDetails}>
                        <View style={styles.productDetailsNamePriceWeight}>
                            ...
                            <View style={styles.productDetailsDefaultPriceWeight}>
                                <Text style={styles.productDetailsDefaultWeightText}>100 гр. / </Text>
                                <Text style={styles.productDetailsDefaultPriceText}>170 грн. </Text>
                            </View>
                        </View>
                        <View style={styles.productPriceCartWrapper}>
                            <Text style={styles.productPriceCartText}>
                                595 грн
                            </Text>
                        </View>
                    </View>
