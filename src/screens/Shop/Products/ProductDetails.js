...
import countMinus from '../../../../assets/images/icons/minus.jpg';
import countPlus from '../../../../assets/images/icons/plus.jpg';
    ...
    return (
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.productWeight}>{weight} гр.</Text>
        </View>
  ...
  renderShortDescription = (shortIngredients, productInfo) => {
    return (
      <View style={styles.consistDescriptionWrapper}>
        <Text style={styles.consistDescriptionTitle}>
          Состав:{' '}
          <Text style={styles.consistDescriptionText}>{shortIngredients}</Text>
        </Text>
        <TouchableOpacity
          onPress={() =>
    ...
    return (
      <View style={styles.counterContentWrapper}>
        ...
        <TouchableOpacity style={styles.addToCartBtn}>
          <Text style={styles.addToCartBtnText}>Добавить в корзину</Text>
        </TouchableOpacity>
      </View>
    );
  };
